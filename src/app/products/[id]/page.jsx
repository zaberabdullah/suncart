          ...
          <div className="flex flex-col pt-4">
            ...
            <div className="space-y-4 mb-12">
               ...
               <div className="pt-4">
                  ...
                  <span className="text-xs font-bold text-gray-900 uppercase tracking-widest ml-2">{product.category}</span>
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-10 border-t border-gray-100 mt-4">
              <div className="flex flex-col gap-2">
                ...
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-tight">Free Express<br/>Shipping</span>
              </div>
              <div className="flex flex-col gap-2">
                <ShieldCheck className="w-6 h-6 text-gray-300" />
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-tight">Authentic<br/>Product</span>
              </div>
              <div className="flex flex-col gap-2">
                <RotateCcw className="w-6 h-6 text-gray-300" />
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-tight">15 Days<br/>Easy Return</span>
              </div>
            </div>
          </div>
        </div>
